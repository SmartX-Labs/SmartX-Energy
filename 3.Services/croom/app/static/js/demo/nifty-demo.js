...
$(document).ready(function () {
    ...
    // BOXED LAYOUT
    // =================================================================
    var boxedLayoutCheckbox = $('#demo-box-lay');
    boxedLayoutCheckbox.on('change', function () {
        if (boxedLayoutCheckbox.niftyCheck('isChecked')) {
            nifty.container.addClass('boxed-layout');
            setCookie('settings-box-layout', true);
        } else {
            nifty.container.removeClass('boxed-layout');
            setCookie('settings-box-layout', false);
        }
        $.niftyNav('update');
        $.niftyAside('update');
    });
