...
public class testSNMPGetBulk
{
	public static void main(String[] args) throws IOException, InterruptedException {
	    ...
	    VariableBinding[] array = {new VariableBinding(new OID("1.3.6.1.2.1.1.1")),
	                               new VariableBinding(new OID("1.3.6.1.2.1.1.2")),
	                               new VariableBinding(new OID("1.3.6.1.2.1.1.3"))};
	    pdu.addAll(array);
